...
export function AuthProvider({ children }: { children: React.ReactNode }) {
  ...
  const isProfesor = role === 'profesor' || role === 'admin';

  return (
    <AuthContext.Provider value={{ user, loading, role, isAdmin, isProfesor, signUp, signIn, signOut }}>
      {children}
