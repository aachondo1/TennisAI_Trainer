...
function CourtDiagram({ origin, position }: { origin: string; position: string }) {
  ...
  const C2 = { accent: '#b5f542', amber: '#f5a623', blue: '#4a9eff', green: '#3dd68c', border: '#1e2328', borderHi: '#2a3038', panel: '#161a1e', textMut: '#404850', textSec: '#7a8694' };

  return (
    <svg width={W} height={H} viewBox={`0 0 ${W} ${H}`} style={{ display: 'block', margin: '0 auto', overflow: 'visible' }}>
      <rect x={cL} y={cT} width={cR-cL} height={cB-cT} fill={C2.accent+'06'} stroke="none" />
